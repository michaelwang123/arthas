...
- [x] 1. Define protocol message types and core data structures
  - [x] 1.1 Add file transfer message type constants and data interfaces to client protocol
  ...
  - [x] 1.2 Add file transfer message type constants and data structures to server protocol
  ...
  - [x] 1.3 Update protocol documentation
...
- [x] 2. Implement server-side file transfer infrastructure
  - [x] 2.1 Adjust WebSocket parameters, add SendFileData, and extend Room Member struct
  ...
  - [x] 2.2 Implement BroadcastFileData on Room with concurrent sending
  ...
  - [x] 2.3 Implement file transfer lifecycle handlers
  ...
  - [x] 2.4 Implement file transfer data relay handlers
  ...
  - [x] 2.5 Register file transfer handlers and configure rate limiter exemption
  ...
  - [x] 2.6 Implement stale transfer cleanup and disconnect handling
  ...
  - [x] 2.7 Write unit tests for server-side file transfer handlers
...
- [x] 3. Implement client-side core modules (file-transfer directory)
  - [x] 3.0 Setup client test environment
  ...
  - [x] 3.1 Create file-transfer module structure, types, ID generator, and chunker
  ...
  - [x] 3.2 Write property test for chunk split/reassemble round-trip
  ...
  - [x] 3.3 Implement chunk-level encryption and decryption
  ...
  - [x] 3.4 Write property test for chunk encryption round-trip
  ...
  - [x] 3.5 Write property test for encrypted chunk structure invariant
  ...
  - [x] 3.6 Implement file name sanitization
  ...
  - [x] 3.7 Write property test for file name sanitization
  ...
  - [x] 3.8 Write property test for file size validation
...
- [x] 4. Implement client-side state management and transfer engines
  - [x] 4.1 Implement fileTransferStore with Zustand
  ...
  - [x] 4.2 Write property test for transfer queue invariant
  ...
  - [x] 4.3 Implement sender engine — core send flow
  ...
  - [x] 4.4 Implement sender engine — flow control and network awareness
  ...
  - [x] 4.5 Implement sender engine — cancel, queue management, and large room warning
  ...
  - [x] 4.6 Implement receiver engine
  ...
  - [x] 4.7 Write property tests for receiver correctness
  ...
  - [x] 4.8 Write property test for progress calculation
...
- [x] 5. Implement client-side UI components
  - [x] 5.1 Implement FileMessage bubble component
  ...
  - [x] 5.2 Implement ProgressBar component
  ...
  - [x] 5.3 Implement FileAttachButton and DropZone components
...
- [x] 6. Wire everything together — integration and message routing
  - [x] 6.1 Integrate file transfer message routing in chatStore
  ...
  - [x] 6.2 Modify MessageInput to include file attachment button and paste handler
  ...
  - [x] 6.3 Modify MessageList to render FileMessage for file-type messages
  ...
  - [x] 6.4 Write integration tests for end-to-end file transfer flow
...
- [x] 7. Implement thumbnail generation, ephemeral mode, and state persistence
  - [x] 7.1 Implement thumbnail generator
  ...
  - [x] 7.2 Implement inline thumbnail preview in FileMessage
  ...
  - [x] 7.3 Write property test for thumbnail constraints
  ...
  - [x] 7.4 Integrate with ephemeral mode
  ...
  - [x] 7.5 Implement transfer state persistence with sessionStorage
  ...
  - [x] 7.6 Write unit tests for ephemeral and persistence
