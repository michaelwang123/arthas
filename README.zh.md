...
**v1.0 — 功能完整版** (2026-05-25)

所有计划功能已实现：E2EE 聊天 + 加密文件分享 + 加密语音消息 + QR 码分享 + 房间过期 + 消息回复/反应 + 密码保护 + 阅后即焚 + Ed25519 签名 + CLI 客户端 + 国际化 + 自托管部署
